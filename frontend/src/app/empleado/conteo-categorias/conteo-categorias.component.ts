...
export class ConteoCategoriasComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        // Subscripción a conteoProductoActualizado
        this.wsSubs.push(
            this.wsService.onConteoProductoActualizado().subscribe({
                next: (msg: ConteoProductoMensaje) => {
                    if (msg.conteoId === this.conteoId) {
                        ...
                        // Marcar como contado si cantidadContada no es null
    ...
    private async loadConteoProductos(): Promise<void> {
        ...
        this.conteoProdService.getConteoProductosByConteoId1(this.conteoId).subscribe({
            next: async (productos) => {
                ...
                // Inicializar countedProducts con productos donde cantidadContada != null
  ...
  <style>
    ...
    th:nth-child(1), td:nth-child(1) { width: 9.09%; }
    th:nth-child(2), td:nth-child(2) { width: 27.27%; }
    th:nth-child(3), td:nth-child(3) { width: 27.27%; }
    th:nth-child(4), td:nth-child(4) { width: 18.18%; }
    th:nth-child(5), td:nth-child(5) { width: 18.18%; }
